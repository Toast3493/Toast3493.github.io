...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ===== НОВОЕ: Окно с информацией с ограниченной высотой ===== */
        .info-content {
            max-height: 200px;
            overflow-y: auto;
            padding-right: 10px;
        ...
        @media (max-width: 768px) {
            ...
            /* На мобильных уменьшаем высоту информационного окна */
            .info-content {
                max-height: 150px;
            }
...
<body class="theme-light locked">
    ...
    <header>
        <div class="header-inner">
            ...
            <nav id="nav">
                <a href="#department-selector" class="tab1">Начать</a>
                <a href="#" class="tab2 fake-tab" data-msg="Скоро будет доступно ✨">Вкладка 2</a>
                <a href="#" class="tab3 fake-tab" data-msg="Раздел в разработке 🚀">Вкладка 3</a>
            </nav>
